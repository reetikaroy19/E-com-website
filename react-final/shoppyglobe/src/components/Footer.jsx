        ...
        <footer className='bg-gray-800 text-white py-8 px-4 md:px-16 lg:px-24'>
                <div className='container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8'>
                   <div>
                    ...
                    <p className='mt-4 '>Your one-step for all your needs. Shop with us and experience the best online
                   ...
                   <div>
                    ...
                    <div className='flex space-x-4 mt-4'>
                        ...
                        <a href="https://in.linkedin.com/" className='hover:text-gray-400'><FaLinkedin /></a>
                    </div>
