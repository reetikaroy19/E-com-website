    ...
    return (
      <div>
        <div className="bg-white mt-2 px-4 md:px-16 lg:px-24">
            <div className="container mx-auto py-4 flex flex-col md:flex-row space-x-6">
                <div className="w-full md:w-3/12">
                    ...
                    <div className="w-full md:w-9/12 mt-8 md:mt-0 h-96 relative">
                      ...
                      <div className="absolute top-16 left-6">
                         <p className="text-3xl text-red-600   mb-4">Welcome To The Shoppy-Glob </p> 
                        <h2 className="text-3xl text-red-600 font-bold">THE BEST PRODUCTS EVER</h2>
                        <p className="text-xl text-white  mt-2.5 font-bold ">MILLIONS+ PRODUCTS</p>
